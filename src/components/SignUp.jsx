...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4">
      <div className="bg-gray-800/70 backdrop-blur-md p-6 sm:p-10 rounded-3xl shadow-2xl w-full max-w-md sm:max-w-lg transform transition-all duration-300 hover:scale-105">
        
 
        <h2 className="text-3xl sm:text-4xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400 mb-6 sm:mb-10 animate-pulse">
            Join DevTalks
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {['firstName', 'lastName'].map((field, i) => (
              <div key={i} className="relative">
                <input
                  ...
                  required
                  className="peer w-full rounded-lg bg-gray-700 text-white placeholder-transparent mt-1 border border-gray-600 px-10 pt-5 pb-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                />
                <label
                  htmlFor={field}
          ...
          <div className="relative">
            <input
              ...
              placeholder="Email"
              required
              className="peer w-full rounded-lg bg-gray-700 text-white placeholder-transparent border border-gray-600 px-10 mt-1 pt-5 pb-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            />
            <label
              htmlFor="emailId"
          ...
          <div className="relative">
            <input
              ...
              required
              className="peer w-full rounded-lg bg-gray-700 text-white placeholder-transparent border border-gray-600 px-10 mt-1 pt-5 pb-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200"
            />
            <label
              htmlFor="password"
              className="absolute left-3 top-2 text-gray-400 text-sm transition-all duration-200 peer-placeholder-shown:top-5 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-base peer-focus:top-2 peer-focus:text-gray-200 peer-focus:text-sm flex items-center gap-2"
